  ...
  return (
    <div className=" w-full h-screen flex  grow items-center  px-4 justify-center">
      <SignUp.Root>
        <SignUp.Step
          name="start"
          className="w-full space-y-6 rounded-2xl bg-neutral-900 bg-[radial-gradient(circle_at_50%_0%,var(--color-white),transparent)]/10 px-4 py-10 ring-1 ring-inset ring-white/5 sm:w-96 sm:px-8"
        >
